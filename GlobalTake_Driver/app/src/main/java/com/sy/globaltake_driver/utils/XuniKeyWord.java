...
//            | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
        ...
        XuniKeyWord.assistActivity(activity.findViewById(android.R.id.content));
        XuniKeyWord.setMargintop(activity.findViewById(android.R.id.content),root_layout,activity);
//        XuniKeyWord.initStateView(activity).setBackgroundColor(activity.getResources().getColor(R.color.statecolor));
    }
