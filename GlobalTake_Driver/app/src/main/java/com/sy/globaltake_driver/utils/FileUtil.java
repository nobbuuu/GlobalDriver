...
public class FileUtil {
    ...
    * */
    ...
    public static File getAppDir(){
        File dir = new File(getSDcardDir(),"QuanJiao");//项目的根目录
        if (!dir.exists()){
            dir.mkdir();
        }
        return dir;
    ...
    * */
    ...
    public static File downloadFile(String httpurl, File dir, String rename, Activity context) {
...
//            conn.setConnectTimeout(5000);
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                int read = -1;
                long download = 0;
                NotificationManager manager = NotifyUtil.getNotificationManager(context);
                while ((read = inputStream.read(buff)) != -1) {
                    ...
                    NotifyUtil.sendAppVersionNotify(context, manager, progress);
                }
                Log.e("tag", "文件下载成功！");
